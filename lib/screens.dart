  ...
  Future<void> _submit() async {
    ...
    try {
      if (AppConfig.isProduction) {
        // Real backend authentication (Ecolamp Backend (FastAPI)).
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: const [
                        ...
                        SizedBox(height: 3),
                        Text(
                          'Recycle your waste at an Ecolamp Smart Station',
                          style: TextStyle(
        ...
        children: [
          ...
          Text(
            summary.depositCount == 0
                ? 'Your impact is calculated from your verified deposits at Ecolamp stations.'
...
class Profile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final items = <(String, IconData, Screen?, void Function()?)>[
      ('My Ecolamp QR', Icons.qr_code, Screen.myQr, null),
        ...
        children: [
          ...
          if (contributions.isEmpty)
            Container(
              ...
              child: const Text(
                'No recycling transactions yet.\nRecycle at an Ecolamp Smart Station to see your deposits here.',
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 11,
                  color: AppColors.mutedForeground,
