...
class AppStore {
  ...
  /// True when this store mirrors the SCWT backend (production
    ...
    _notifications.insert(
      ...
      AppNotification(
        ...
        title: contribution.points > 0
            ...
            : 'Deposit verified',
        body:
            '${contribution.materialType} verified at ${stationName ?? 'an SCWT station'}.',
        time: 'Just now',
        iconKey: 'eco',
      ),
    );
  ...
  Future<void> completeVerifiedDeposit(Contribution contribution) async {
    ...
    _notifications.insert(
      ...
      AppNotification(
        ...
        body:
            '${contribution.materialType} verified at ${currentStation?.name ?? 'an SCWT station'}.',
        time: 'Just now',
        iconKey: 'eco',
      ),
    );
