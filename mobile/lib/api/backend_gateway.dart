...
/// Production-mode gateway to the SCWT backend.
///
/// Responsibilities:
...
class BackendGateway {
  ...
  static const _tokenKey = 'scwt_session_token';
  static const _emailKey = 'scwt_session_email';
  ...
  static String handoffQrPayload(String token) => 'SCWT:HANDOFF:$token';
