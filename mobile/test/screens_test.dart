...
import 'package:scwt_flutter/models.dart';
import 'package:scwt_flutter/repositories.dart';
import 'package:scwt_flutter/screens.dart';
import 'package:scwt_flutter/app_flow_nav.dart';
import 'package:scwt_flutter/flow_screens.dart';
import 'package:scwt_flutter/store.dart';
import 'package:scwt_flutter/theme.dart';
...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      expect(
        find.text('Recycle your waste at an SCWT Smart Station'),
        findsOneWidget,
      );
